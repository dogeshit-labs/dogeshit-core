...
/** @title FastShit
		@notice FastShit is an ERC20 token, designed so only 2 specified addresses have the ability to mint Fastshit.
		@dev Fastshit should be deployed after the ShitFountain and ShitLord contracts have been deployed,
			as these contracts should be the only two contracts with the ability to mint Fastshit.
*/
contract FastShit is AccessControlEnumerable, ERC20 {
	...
	*/
	constructor(address _shitMaker, address _rewardsPool) ERC20("FastShit", "fastSHT") {
